...
/**
 * Title: home
 * Slug: mondoroccochild/home
 * Categories: hidden
 * Inserter: no
 */
?>
<!-- wp:group {"style":{"position":{"type":"sticky","top":"0px"}},"layout":{"type":"default"}} -->
<div class="wp-block-group"><!-- wp:template-part {"slug":"header-rocco-copy","tagName":"header"} /--></div>
<!-- /wp:group -->
...
<figure class="wp-block-image alignwide size-full is-style-rounded"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/building-exterior.webp" alt="<?php echo esc_attr_e( 'Building exterior in Toronto, Canada', 'Mondo Rocco Child' ); ?>"/></figure>
<!-- /wp:image --></div>
<!-- /wp:group -->
...
<figure class="wp-block-image size-large is-style-rounded"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/tourist-and-building.webp" alt="<?php echo esc_attr_e( 'Tourist taking photo of a building', 'Mondo Rocco Child' ); ?>"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
...
<div class="wp-block-column" style="flex-basis:50%"><!-- wp:image {"sizeSlug":"large","linkDestination":"none","className":"is-style-rounded"} -->
<figure class="wp-block-image size-large is-style-rounded"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/windows.webp" alt="<?php echo esc_attr_e( 'Windows of a building in Nuremberg, Germany', 'Mondo Rocco Child' ); ?>"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column -->
...
<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|60","bottom":"var:preset|spacing|60","left":"var:preset|spacing|60","right":"var:preset|spacing|60"},"margin":{"top":"0","bottom":"0"}}},"backgroundColor":"contrast","textColor":"base","layout":{"type":"constrained","contentSize":""},"metadata":{"name":"Testimonial"}} -->
...
<div class="wp-block-group alignwide"><!-- wp:query {"queryId":6,"query":{"perPage":10,"pages":0,"offset":0,"postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":true},"align":"wide","layout":{"type":"default"}} -->
